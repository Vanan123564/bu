...
banner = f"""
        ...
        {xanh_duong}░╚████╔╝░╚██████╔╝██║░░██║███████║╚██████╔╝██████╔╝██║░╚████║╚██████╔╝╚██████╔╝██║░╚████║
        {trang}░░╚═══╝░░░╚═════╝░╚═╝░░╚═╝╚══════╝░╚═════╝░╚═════╝░╚═╝░░╚═══╝░╚═════╝░░╚═════╝░╚═╝░░╚═══╝
{trang}           </> Buff like sub giá rẻ tại VuaSubNgon.Com </>
\033[1;37m────────────────────────────────────────────────────────────
{do}[{trang}{kt_code}{do}] {vang}BOT VIEW TIK TOK MAX SPEED 
{do}[{trang}{kt_code}{do}] \033[1;35mADMIN:\033[1;36m NGUYỄN BÁ ĐỨC
{do}[{trang}{kt_code}{do}] \033[1;31mZALO: \033[1;33mzalo.me/vuasubngon
{do}[{trang}{kt_code}{do}] {dac_biet}YOUTUBE:\033[1;37m VuaSubNgon
\033[1;37m────────────────────────────────────────────────────────────"""
